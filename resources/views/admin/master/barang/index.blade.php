                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <canvas id="qr-code" style="margin-top: 20px; width: 200px; height: 200px;"></canvas> <!-- Canvas for QR Code -->
                                        <button id="download-qr" class="btn btn-primary mt-2" style="display: none;">Download QR Code</button> <!-- Download button -->
    ...
    $.ajax({
        ...
        success: function({ data }) {
            ...
            const qr = new QRious({
                    ...
                    value: `http://localhost/barang/code/${data.code}`, // Change this to your actual URL
                    size: 200 // Size of the QR code
                });

                // Show the download button
                $("#download-qr").show().off('click').on('click', function() {
                    const qrCanvas = document.getElementById('qr-code');
                    const link = document.createElement('a');
                    link.href = qrCanvas.toDataURL("image/png");
                    link.download = `${data.code}.png`; // Set the filename to the code of the item
                    link.click();
                });
